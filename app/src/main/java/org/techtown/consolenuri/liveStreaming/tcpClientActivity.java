...
public class tcpClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 송신 스레드 가동
                SendToServerThread thread = new SendToServerThread(member_socket, "나갔습니다.");
                thread.start();
                finish();
            }
        });
            ...
            try {
                while (isRunning) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // 텍스트뷰의 객체를 생성
                            TextView tv = new TextView(tcpClientActivity.this);
    ...
    protected void onDestroy() {
        // 송신 스레드 가동
        SendToServerThread thread = new SendToServerThread(member_socket, "나갓습니다.");
        thread.start();
